...
def Battle(event):
   ...
   x=player_position[0]
   y=player_position[1]
   background_image = pygame.image.load("png/4-space.jpg").convert()
   background = pygame.Surface((400, 200))
   ship_sf = pygame.Surface((290,200))
   ship_image = pygame.image.load("png/Free Planets Alliance/Battleship/Hyperion.jpg").convert()
   ship_image.set_colorkey((255,255,255))
   #в Fs наложение загугли
